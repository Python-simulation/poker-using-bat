...
set nombre_carte=0
for %%a in (AA AB AC AD 2A 2B 2C 2D 3A 3B 3C 3D 4A 4B 4C 4D 5A 5B 5C 5D 6A 6B 6C 6D 7A 7B 7C 7D 8A 8B 8C 8D 9A 9B 9C 9D 10A 10B 10C 10D JA JB JC JD QA QB QC QD KA KB KC KD) do set /a nombre_carte+=1& set carte[!nombre_carte!]=%%a
...
if !type%%i[%nom_joueur%]!==A set type%%i[%nom_joueur%]=A
if !type%%i[%nom_joueur%]!==B set type%%i[%nom_joueur%]=B
if !type%%i[%nom_joueur%]!==C set type%%i[%nom_joueur%]=C
if !type%%i[%nom_joueur%]!==D set type%%i[%nom_joueur%]=D
